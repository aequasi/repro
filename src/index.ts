    ...
    async run() {
        ...
        if (!args.repo) {
            ...
            try {
                ...
                return this.error(
                    'No repository passed, and couldn\'t figure out the current directory\'s origin remote url.')
            }
        ...
        try {
                    ...
                    task:  () => new Listr([
                        {
                            ...
                            task:  () => fs.writeFile(
                                ...
                                JSON.stringify(config.package, null, 4)
                            ),
                        },
                        {
            ...
            this.log(`
Finished creating reproduction! When you're done preparing it, upload it to git, or run: 
